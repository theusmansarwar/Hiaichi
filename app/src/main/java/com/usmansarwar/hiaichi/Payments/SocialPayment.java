...
public class SocialPayment extends AppCompatActivity {
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (trx.isEmpty() ) {
                    ...
                    Toast.makeText(SocialPayment.this, "Make sure you fill complete form", Toast.LENGTH_SHORT).show();
                    ...
                    userModel2.setTittle("Social");

                    db2.child(key).setValue(userModel2).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(SocialPayment.this, "Request Sent Successfully, Please Wait 48 hours to activate your course", Toast.LENGTH_SHORT).show();

                            startActivity(new Intent(SocialPayment.this, MainActivity2.class));
                        }

                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(SocialPayment.this, "Error" + e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            {////////////////first
                ...
                if(id== R.id.menu_home) {
                    ...
                    Intent intent = new Intent(SocialPayment.this, MainActivity2.class);
                ...
                if(id== R.id.menu_Available) {
                    ...
                    Intent intent = new Intent(SocialPayment.this, Available.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Buy) {
                    ...
                    Intent intent = new Intent(SocialPayment.this, Buy.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Edit) {
                    ...
                    Intent intent = new Intent(SocialPayment.this, Edit.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Contact) {
                    ...
                    Intent intent = new Intent(SocialPayment.this, Contact.class);
                    startActivity(intent);
                    return true;

                }
                if(id== R.id.menu_policy) {
                    Intent intent = new Intent(SocialPayment.this, Policy.class);
                    startActivity(intent);
    ...
    protected void onStart() {
        ...
        db3.child("Social").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
