...
public class DAtaAvailibility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(DAtaAvailibility.this, "Some data missing ", Toast.LENGTH_SHORT).show();
                    ...
                    dbreference.child("Data").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Data").child("Price").setValue(Price);
                                dbreference.child("Data").child("Short").setValue(Description);
                                dbreference.child("Data").child("type").setValue(num);
                                Toast.makeText(DAtaAvailibility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
