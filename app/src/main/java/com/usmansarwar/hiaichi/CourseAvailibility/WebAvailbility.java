...
public class WebAvailbility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(WebAvailbility.this, "Some data missing ", Toast.LENGTH_SHORT).show();

                } else {

                    dbreference.child("Web").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Web").child("Price").setValue(Price);
                                dbreference.child("Web").child("Short").setValue(Description);
                                dbreference.child("Web").child("type").setValue(num);
                                Toast.makeText(WebAvailbility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
