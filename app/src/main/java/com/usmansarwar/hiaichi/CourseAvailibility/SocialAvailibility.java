...
public class SocialAvailibility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(SocialAvailibility.this, "Some data missing ", Toast.LENGTH_SHORT).show();

                } else {

                    dbreference.child("Social").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Social").child("Price").setValue(Price);
                                dbreference.child("Social").child("Short").setValue(Description);
                                dbreference.child("Social").child("type").setValue(num);
                                Toast.makeText(SocialAvailibility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
