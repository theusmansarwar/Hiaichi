...
public class GameAvailibility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(GameAvailibility.this, "Some data missing ", Toast.LENGTH_SHORT).show();

                } else {

                    dbreference.child("Game").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Game").child("Price").setValue(Price);
                                dbreference.child("Game").child("Short").setValue(Description);
                                dbreference.child("Game").child("type").setValue(num);
                                Toast.makeText(GameAvailibility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
