...
public class GraphicAvailibility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(GraphicAvailibility.this, "Some data missing ", Toast.LENGTH_SHORT).show();

                } else {

                    dbreference.child("Graphic").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Graphic").child("Price").setValue(Price);
                                dbreference.child("Graphic").child("Short").setValue(Description);
                                dbreference.child("Graphic").child("type").setValue(num);
                                Toast.makeText(GraphicAvailibility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
