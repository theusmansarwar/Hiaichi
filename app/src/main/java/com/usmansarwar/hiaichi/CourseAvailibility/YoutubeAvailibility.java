...
public class YoutubeAvailibility extends AppCompatActivity {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Price.isEmpty() || Description.isEmpty()) {
                    ...
                    Toast.makeText(YoutubeAvailibility.this, "Some data missing ", Toast.LENGTH_SHORT).show();

                } else {

                    dbreference.child("Youtube").addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            try {
                                dbreference.child("Youtube").child("Price").setValue(Price);
                                dbreference.child("Youtube").child("Short").setValue(Description);
                                dbreference.child("Youtube").child("type").setValue(num);
                                Toast.makeText(YoutubeAvailibility.this, "Data Updated ", Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
