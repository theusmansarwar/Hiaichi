...
public class Social extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Social.this);
        recyclerView.setLayoutManager(layoutManager);
        adapter=new Adapter (list, Social.this);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            {////////////////first
                ...
                if(id== R.id.menu_home) {
                    ...
                    Intent intent = new Intent(Social.this, MainActivity2.class);
                ...
                if(id== R.id.menu_Available) {
                    ...
                    Intent intent = new Intent(Social.this, Available.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Buy) {
                    ...
                    Intent intent = new Intent(Social.this, Buy.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Edit) {
                    ...
                    Intent intent = new Intent(Social.this, Edit.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Contact) {
                    ...
                    Intent intent = new Intent(Social.this, Contact.class);
                    startActivity(intent);
                    return true;

                }
                if(id== R.id.menu_policy) {
                    Intent intent = new Intent(Social.this, Policy.class);
                    startActivity(intent);
    ...
    public void getData(){
        ...
        FirebaseDatabase.getInstance().getReference("Videos").child("SocialMediaMarketingVideos")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(Social.this, error.getMessage(), Toast.LENGTH_SHORT).show();
