...
public class Blockchain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Blockchain.this);
        recyclerView.setLayoutManager(layoutManager);
        adapter = new Adapter(list, Blockchain.this);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem){////////////////first
                int id = menuItem.getItemId();
                if (id == R.id.menu_home) {

                    startActivity ( new Intent( Blockchain.this, MainActivity2.class ) );
                    finish ();
                    return true;

                }
                else if (id == R.id.menu_Available) {

                    Intent intent = new Intent(Blockchain.this, Available.class);
                    ...
                    Intent intent = new Intent(Blockchain.this, Buy.class);
                    startActivity(intent);
                    return true;
                    ...
                    Intent intent = new Intent(Blockchain.this, Edit.class);
                    startActivity(intent);
                    return true;
                    ...
                    Intent intent = new Intent(Blockchain.this, Contact.class);
                    startActivity(intent);
                    return true;

                }
                else if (id == R.id.menu_policy) {
                    Intent intent = new Intent(Blockchain.this, Policy.class);
                    startActivity(intent);
    ...
    public void getData(){
        ...
        FirebaseDatabase.getInstance().getReference("Videos").child("BlockchainVideos")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(Blockchain.this, error.getMessage(), Toast.LENGTH_SHORT).show();
