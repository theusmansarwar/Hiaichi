...
public class Youtube extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Youtube.this);
        recyclerView.setLayoutManager(layoutManager);
        adapter=new Adapter (list, Youtube.this);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            {////////////////first
                ...
                if(id== R.id.menu_home) {
                    ...
                    Intent intent = new Intent(Youtube.this, MainActivity2.class);
                ...
                if(id== R.id.menu_Available) {
                    ...
                    Intent intent = new Intent(Youtube.this, Available.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Buy) {
                    ...
                    Intent intent = new Intent(Youtube.this, Buy.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Edit) {
                    ...
                    Intent intent = new Intent(Youtube.this, Edit.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Contact) {
                    ...
                    Intent intent = new Intent(Youtube.this, Contact.class);
                    startActivity(intent);
                    return true;

                }
                if(id== R.id.menu_policy) {
                    Intent intent = new Intent(Youtube.this, Policy.class);
                    startActivity(intent);
    ...
    public void getData(){
        ...
        FirebaseDatabase.getInstance().getReference("Videos").child("YoutubeVideos")
