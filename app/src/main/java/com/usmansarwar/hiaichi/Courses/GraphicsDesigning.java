...
public class GraphicsDesigning extends AppCompatActivity {
    NavigationView nav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(GraphicsDesigning.this);
        recyclerView.setLayoutManager(layoutManager);
        adapter=new Adapter (list, GraphicsDesigning.this);
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            {////////////////first
                ...
                if(id== R.id.menu_home) {
                    ...
                    Intent intent = new Intent(GraphicsDesigning.this, MainActivity2.class);
                ...
                if(id== R.id.menu_Available) {
                    ...
                    Intent intent = new Intent(GraphicsDesigning.this, Available.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Buy) {
                    ...
                    Intent intent = new Intent(GraphicsDesigning.this, Buy.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Edit) {
                    ...
                    Intent intent = new Intent(GraphicsDesigning.this, Edit.class);
                    startActivity(intent);
                    return true;
                ...
                if(id== R.id.menu_Contact) {
                    ...
                    Intent intent = new Intent(GraphicsDesigning.this, Contact.class);
                    startActivity(intent);
                    return true;

                }
                if(id== R.id.menu_policy) {
                    Intent intent = new Intent(GraphicsDesigning.this, Policy.class);
                    startActivity(intent);
    ...
    public void getData(){
        ...
        FirebaseDatabase.getInstance().getReference("Videos").child("GraphicsDesigningVideos")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(GraphicsDesigning.this, error.getMessage(), Toast.LENGTH_SHORT).show();
